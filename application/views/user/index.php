                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-7">
                            <div class="welcome-text">
                                ...
                                <h2>
                                <span>SELAMAT DATANG DI</span> <span class="coloring">HOTEL HEBAT</span>
                                </h2>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title mb-80">
                            <h2>Tentang <span>Cloud</span></h2>
                            <p>Aplikasi ini dirancang untuk memenuhi tugas kuliah Pemograman Framework</p>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="about-chondo">
                            <div class="about-member">
                                <img src="<?=base_url()?>/assets/images/o.jpg" alt="">
                                <h3>Asti Oktaviani</h3>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-8 col-xs-12">
                        <p>Copyright© Created by  Asti Oktaviani </p>
                    </div>
                </div>
            </div>
        </div>
