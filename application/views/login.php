...
<head>
    ...
    <link rel="icon" href="<?=base_url()?>/images/.png">
</head>
    <style type="text/css">
...
body{
  font-family: 'Mukta', sans-serif;
    height:100vh;
    min-height:550px;
    background-image: url(<?= base_url()?>/assets/images/kamar/twin1.jpg);
...
<body>
    <div class="login-reg-panel">
        <div class="login-info-box">
            ...
            <p>Silahkan Anda login disini</p>
        ...
        <div class="register-info-box">
            ...
            <p>Silahkan Melakukan pendaftaran sekarang</p>
